...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Enhencer - Listing Page",
  ...
  "description": "This tag has to fire after the product listing page loaded successfully.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    ...
    "help": "The category of the listing page viewed"
  },
  {
    "type": "TEXT",
    "name": "userID",
...
const listingPage = ()=>{
  ...
  let cons = callInWindow('enhencerCollector.listingPage', {listingCategory: cat});
            ...
            "listItem": [
              ...
              },
              {
                ...
                "mapValue": [
                  {
                    "type": 1,
                    "string": "enhencerCollector.listingPage"
                  },
                  {
                    "type": 8,
                    "boolean": true
...
Created on 6/2/2021, 9:24:43 AM
